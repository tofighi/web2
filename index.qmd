...
<div style="overflow: hidden;">
  <img src="images/logo.svg" alt="Logo" style="width: 20%; max-width: 100px; height: auto; float: left; margin: 0 10px 10px 0;">
  <p>
    A course about machine learning and its applications, exploring the foundational principles and modern techniques used in the field. 
    Students will learn how to build and train models, analyze real-world data, and implement algorithms for tasks such as prediction, classification, and clustering. 
    This course also covers the ethical considerations and societal impact of deploying machine learning technologies.
  </p>
</div>
